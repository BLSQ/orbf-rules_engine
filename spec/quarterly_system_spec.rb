...
RSpec.describe "Quarterly lookup in monthly System" do
    let(:period) { "2016Q1" }
    ...
    let(:states) { %i[declared verified] }
          ...
          Orbf::RulesEngine::Rule.new(
            ...
            formulas: [
              build_activity_formula(
                "verified_price", "(verified_quarterly - declared) * price",
                "Activity amount"
              )
            ]
          ),
    ...
    let(:dhis2_values) do
      [
        { "dataElement" => "dhis2_act1_verified", "categoryOptionCombo" => "default", "value" => "18", "period" => "2016Q1", "orgUnit" => "1" },
        
        { "dataElement" => "dhis2_act1_declared", "categoryOptionCombo" => "default", "value" => "1", "period" => "201601", "orgUnit" => "1" },
        { "dataElement" => "dhis2_act1_declared", "categoryOptionCombo" => "default", "value" => "2", "period" => "201602", "orgUnit" => "1" },
        { "dataElement" => "dhis2_act1_declared", "categoryOptionCombo" => "default", "value" => "3", "period" => "201603", "orgUnit" => "1" },
      ]
    end
    ...
    it "should register activity_variables" do
      ...
      expect(problem["quantity_act1_verified_for_1_and_201601"]).to eq("18")
    end
  
    let(:expected_problem) { JSON.parse(fixture_content(:rules_engine, "quarterly_problem.json")) }
    ...
    let(:expected_solution) { JSON.parse(fixture_content(:rules_engine, "quarterly_solution.json")) }
